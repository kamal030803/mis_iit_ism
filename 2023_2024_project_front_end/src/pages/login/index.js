...
const LoginPage = () => {
  ...
  const [useRecaptha, setRecapcha] = useState(false);
  // ** Hooks
  const auth = useAuth()
  ...
  const imageSource = skin === 'bordered' ? 'tms' : 'tms'
        ...
        >
          <BoxWrapper>
            ...
            <form noValidate autoComplete='off' onSubmit={handleSubmit(onSubmit)}>
              ...
              > */}
              <FormControl fullWidth sx={{ mb: 4, display: 'flex', alignItems: 'center', flexWrap: 'wrap', justifyContent: 'space-between' }}>
                <ReCAPTCHA
                  sitekey="6Le0McEZAAAAAH44HWI6hbgGyCypbK9Ugdn-SqAT"
                  ref={recaptchaRef}
                  onChange={onChange}
                />
                ...
                {errors.recaptchaValue && (
                  <FormHelperText sx={{ color: 'error.main' }} id='recaptchaValue'>
